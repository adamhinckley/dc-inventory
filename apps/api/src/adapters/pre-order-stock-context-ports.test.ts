...
import { preOrderCaseQtyReadPort } from "./pre-order-stock-context-ports.js";
...
describe("preOrderCaseQtyReadPort", () => {
  it("loads case qty with one findBySkus and one findByProductIds call", async () => {
    ...
    const port = preOrderCaseQtyReadPort(products, packaging);

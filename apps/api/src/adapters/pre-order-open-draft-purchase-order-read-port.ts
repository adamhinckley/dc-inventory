...
export function preOrderOpenDraftPurchaseOrderReadPort(
  ...
  async function findOpenDraftsForSupplierSkus(
    ...
    const draftByKey = new Map<string, PreOrderOpenDraftPurchaseOrderRef>();
...
export function inMemoryPreOrderOpenDraftPurchaseOrderReadPort(
  purchaseOrderRepo: IPurchaseOrderRepository,
): IPreOrderOpenDraftPurchaseOrderReadPort {
  return new InMemoryPreOrderOpenDraftPurchaseOrderReadPort(purchaseOrderRepo);
}

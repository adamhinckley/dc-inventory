...
export function planDemoBook(input: PlanDemoBookOptions): DemoBookPlan {
  ...
  const plan: DemoBookPlan = {
    ...
    master: {
      ...
      staffDisplayName: identity.staffDisplayName,
      wholesaleEmail: identity.wholesaleEmail,
      wholesaleDisplayName: identity.wholesaleDisplayName,
      wholesaleCustomerKey: identity.wholesaleCustomerKey,
      secondaryWholesaleEmail: identity.secondaryWholesaleEmail,
      secondaryWholesaleDisplayName: identity.secondaryWholesaleDisplayName,

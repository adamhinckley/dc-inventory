            ...
            >
              ...
              <div className="mt-auto flex flex-wrap gap-2">
                ...
                {isActive ? null : (
                  <button
                    type="button"
                    onClick={() => setActiveCart(draft.id)}
                ...
                <Link
                  href={`/checkout?cart=${draft.id}`}
                  className="ml-auto inline-flex min-h-10 items-center rounded-full bg-accent px-4 text-sm font-semibold text-on-accent hover:bg-accent-hover"
                >
                  Checkout
                </Link>
              </div>

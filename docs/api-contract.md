...
Companion to [`architecture.md`](./architecture.md), [`stack.md`](./stack.md), [`tax.md`](./tax.md) (checkout quote / invoice commit; not computed in the UI), and [`observability.md`](./observability.md) (ops signals; not part of the UI contract).

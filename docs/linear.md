...
| [Onboarding — three tiers](https://linear.app/adamhinckley/project/onboarding-three-tiers-a67692ec504c) | Tier 1 org + first admin (platform only); tier 3 pending-until-approve + staff-for-them + wholesale invite. Folds former account-request project. Spec: [`customers.md`](./customers.md) §15. Map: [DCI-406](https://linear.app/adamhinckley/issue/DCI-406). Docs lock: [DCI-421](https://linear.app/adamhinckley/issue/DCI-421) (supersedes [DCI-413](https://linear.app/adamhinckley/issue/DCI-413)). |

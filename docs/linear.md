...
| [Wholesale — order history](https://linear.app/adamhinckley/project/wholesale-order-history-19d63c6943ef) | Shop `/orders` history and `/orders/SO-xxxxx` detail. Map: [ADA-402](https://linear.app/adamhinckley/issue/ADA-402/wholesale-order-history-implementation-map). HTTP by document number is [ADA-403](https://linear.app/adamhinckley/issue/ADA-403/get-wholesale-sales-order-by-document-number); UI is [ADA-404](https://linear.app/adamhinckley/issue/ADA-404/wholesale-orders-list-links-and-ordersso-xxxxx-detail). |

...
- [x] Exemption certificates stay reseller paperwork only — not a tax engine, not a confirm/ship gate ([TX3](./invariants.md#10a-tax-none); closed with [G21](./invariants.md#g21-sales-tax)).

Schema field glossary derived from the product browser CSV export. Use the **Verified** column to confirm each description matches the source system.
...
| mp_price | Mid-tier or member price, possibly MAP or discounted wholesale price. | - [ ] |
